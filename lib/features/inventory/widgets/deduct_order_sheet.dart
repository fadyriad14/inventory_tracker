...
class DeductOrderSheet extends StatefulWidget {
  final AppDb db;
  final Item item;

  const DeductOrderSheet({
    super.key,
    required this.db,
    required this.item,
  });
  ...
  @override
  State<DeductOrderSheet> createState() => _DeductOrderSheetState();
}

class _DeductOrderSheetState extends State<DeductOrderSheet> {
  final _formKey = GlobalKey<FormState>();

  final _boxesCtrl = TextEditingController(text: '0');
  final _unitsCtrl = TextEditingController(text: '0');
  final _noteCtrl = TextEditingController(text: 'Order');
            ...
            SizedBox(
              ...
              child: FilledButton.icon(
                ...
                label: _saving
                    ...
                    : const Text('Deduct from inventory'),
              ),
            ),
          ],
        ),
